    ...
    <DashboardLayout title="Settings">
      <div className="flex items-start sm:items-center justify-between mb-4 sm:mb-6 gap-2">
        <div>
          ...
          <p className="text-[#94A3B8] text-xs sm:text-sm">Manage your account preferences.</p>
        </div>
      </div>
        ...
        <div className="w-full max-w-2xl space-y-4">
          ...
          <div className="bg-[#111827] border border-white/10 rounded-xl p-4 sm:p-6">
            ...
            <div className="space-y-3">
              <div>
                <p className="text-[#94A3B8] text-xs mb-1">Full Name</p>
                <div className="bg-[#0D1321] border border-white/10 rounded-lg px-3 sm:px-4 py-2.5">
              ...
              <p className="text-[#4B5563] text-[10px]">
                To update your name or email, go to{" "}
                <a href="/profile" className="text-[#00D4AA] hover:underline">
                  Profile page
                </a>
                .
              </p>
          ...
          {/* Notifications */}
          <div className="bg-[#111827] border border-white/10 rounded-xl p-4 sm:p-6">
            <p className="text-[#00D4AA] text-[10px] font-bold tracking-widest mb-4">
              ● NOTIFICATIONS
            </p>
            <div className="flex items-start justify-between gap-4">
              <div className="flex-1 min-w-0">
                <p className="text-white text-sm font-semibold mb-1">Daily Job Digest Email</p>
                <p className="text-[#94A3B8] text-xs leading-relaxed">
                  Receive your top 5 AI-matched job opportunities every morning at 8 AM. Turn this
                  off to stop receiving daily digest emails.
                </p>
              </div>
              {/* Toggle */}
              <button
            ...
            <div className="mt-4 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
              <p className="text-[#4B5563] text-[10px]">
                ...
                <span className={digestEnabled ? "text-[#00D4AA]" : "text-[#FF4D6D]"}>
                  {digestEnabled
                    ? "Enabled — agent runs daily at 8:00 AM"
                    : "Disabled — no digest emails will be sent"}
                </span>
              </p>
              <button
                onClick={handleSaveNotifications}
                className="w-full sm:w-auto flex-shrink-0 bg-gradient-to-r from-[#00D4AA] to-[#0099FF] text-white text-xs font-semibold px-4 py-2 rounded-lg hover:opacity-90 transition"
              >
                {settingsSaved ? "✓ Saved" : "Save"}
              </button>
            </div>
            ...
            <div className="space-y-3">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-[#0D1321] border border-white/10 rounded-lg px-3 sm:px-4 py-2.5 text-white text-sm placeholder-[#4B5563] focus:outline-none focus:border-[#00D4AA]/50"
                />
              </div>
              <div>
                <p className="text-[#94A3B8] text-xs mb-1">New Password</p>
              ...
              <button
                onClick={handleChangePassword}
                disabled={passwordLoading}
                className="w-full sm:w-auto bg-gradient-to-r from-[#00D4AA] to-[#0099FF] text-white text-xs font-semibold px-5 py-2.5 rounded-lg hover:opacity-90 transition disabled:opacity-50"
              >
                {passwordLoading ? "Changing..." : "Change Password"}
              </button>
            </div>
